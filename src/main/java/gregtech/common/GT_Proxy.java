...
//								GT_Log.ore.println(tModToName + " uses an unknown Material. Report this to GregTech.");
    ...
    public Fluid addAutogeneratedMoltenHot(Materials aMaterial) {
        return addFluid("moltenhot." + aMaterial.mName.toLowerCase(Locale.ENGLISH), "moltenhot.autogenerated", aMaterial.mDefaultLocalName + " Molten Hot", aMaterial,
                aMaterial.mMoltenRGBa, 4, 5000, null, null, 0);
    }
        ...
        if (aMaterial != null) {
            switch (aState) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    aMaterial.mStandardMoltenHotFluid = rFluid;
            }
        }
