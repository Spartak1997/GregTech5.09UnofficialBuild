...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static void genMaterials() {
        ...
        Draconium = new Materials(975, TextureSet.SET_SHINY, 20.0F, 32768, 7, 1 | 2 | 8 | 32 | 64, 122, 68, 176, 0, "Draconium", "Draconium", 0, 0, 5000, 7200, true, false, 3, 1, 1, Dyes.dyePink).disableAutoGeneratedBlastFurnaceRecipes();
        DraconiumAwakened = new Materials(976, TextureSet.SET_SHINY, 40.0F, 65536, 8, 1 | 2 | 8 | 32 | 648, 244, 78, 0, 0, "DraconiumAwakened", "Awakened Draconium", 0, 0, 9000, 10000, true, false, 3, 1, 1, Dyes.dyeOrange).disableAutoGeneratedBlastFurnaceRecipes();

        //EnderIO
        RedstoneAlloy = new Materials(365, TextureSet.SET_METALLIC, 3.0F, 128, 2, 1 | 2 | 64, 181, 51, 51, 0, "RedstoneAlloy", "Redstone Alloy", 0, 0, 671, 1000, true, false, 1, 1, 1, Dyes.dyeRed).disableAutoGeneratedBlastFurnaceRecipes();
        Soularium = new Materials(366, TextureSet.SET_METALLIC, 8.0F, 256, 2, 1 | 2 | 64, 65, 46, 29, 0, "Soularium", "Soularium", 0, 0, 800, 1000, true, false, 3, 1, 1, Dyes.dyeBrown).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        ConductiveIron = new Materials(367, TextureSet.SET_METALLIC, 6.0F, 256, 3, 1 | 2 | 64, 217, 178, 171, 0, "ConductiveIron", "Conductive Iron", 0, 0, -1, 1200, true, false, 4, 1, 1, Dyes.dyeRed).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        EnergeticAlloy = new Materials(369, TextureSet.SET_METALLIC, 12.0F, 1024, 3, 1 | 2 | 64, 255, 170, 81, 0, "EnergeticAlloy", "Energetic Alloy", 0, 0, -1, 2200, true, false, 3, 1, 1, Dyes.dyeOrange).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        PulsatingIron = new Materials(379, TextureSet.SET_METALLIC, 6.0F, 256, 3, 1 | 2 | 64, 128, 246, 155, 0, "PulsatingIron", "Pulsating Iron", 0, 0, -1, 1800, true, false, 4, 1, 1, Dyes.dyeLime).disableAutoGeneratedBlastFurnaceRecipes();
