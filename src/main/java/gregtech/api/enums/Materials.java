...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static void genMaterials() {
        ...
        HSLA = new Materials(322, TextureSet.SET_METALLIC, 6.0F, 500, 2, 1 | 2 | 64 | 128, 128, 128, 128, 0, "HSLA", "HSLA Steel", 0, 0, 1811, 1000, true, false, 3, 1, 1, Dyes._NULL, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 1), new TC_AspectStack(TC_Aspects.ORDO, 1))).disableAutoGeneratedBlastFurnaceRecipes();
