...
public class Materials implements IColorModulationContainer, ISubTagContainer {
 ...
 // Polybenzimidazole stuff
    ...
    public static Materials MysteriousCrystal       	= new Materials( 394, TextureSet.SET_DIAMOND,   8.0F,    256,  6, 1|2|8 |64      ,  22, 133, 108,   0,   "MysteriousCrystal"        ,	"Mysterious Crystal"		,	0,	0,	7200,	7200,  true,	false,	4,	1,	1, Dyes.dyeCyan         ).disableAutoGeneratedBlastFurnaceRecipes();
    public static Materials EnrichedMysteriousCrystal	= new Materials( 395, TextureSet.SET_DIAMOND,   8.0F,    256,  6, 1|2   |64      ,  28, 162, 108,   0,   "EnrichedMysteriousCrystal",	"Enriched Mysterious Crystal"	,	0, 	0,	7200,   7200,  true,	false,	4,	1,	1, Dyes.dyeCyan         ).disableAutoGeneratedBlastFurnaceRecipes();
