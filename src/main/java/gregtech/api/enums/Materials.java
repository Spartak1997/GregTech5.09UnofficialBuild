...
public class Materials implements IColorModulationContainer, ISubTagContainer {
 ...
 // Polybenzimidazole stuff
    ...
    public static Materials MysteriousCrystal       = new Materials( 394, TextureSet.SET_DIAMOND ,   8.0F,    256,  6, 1|4|8 |64      ,  22, 133, 108,   0,   "MysteriousCrystal"       ,  "Mysterious Crystal"         ,0,       0,     10800,  10800,  true, true, 5, 64, 1, Dyes.dyeCyan         );
	public static Materials EnrichedMysteriousCrystal= new Materials( 395, TextureSet.SET_DIAMOND,   8.0F,    256,  6, 1|4|8 |64      ,  28, 162, 108,   0,   "EnrichedMysteriousCrystal", "Enriched Mysterious Crystal",0,       0,     10800,  10800,  true, true, 5, 64, 1, Dyes.dyeCyan         );
