...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static void genMaterials() {
        ...
        Antimony = new Materials(58, TextureSet.SET_SHINY, 1.0F, 0, 2, 1 | 2 | 8 | 32, 220, 220, 240, 0, "Antimony", "Antimony", 0, 0, 903, 0, false, false, 2, 1, 1, Dyes.dyeLightGray, Element.Sb, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.AQUA, 1)));
        ...
        Vanadium = new Materials(29, TextureSet.SET_METALLIC, 1.0F, 0, 2, 1 | 2 | 8 | 32, 50, 50, 50, 0, "Vanadium", "Vanadium", 0, 0, 2183, 2183, true, false, 2, 1, 1, Dyes.dyeBlack, Element.V, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.RADIO, 1)));
        ...
        Birmabright = new Materials         ( 77, TextureSet.SET_SHINY,128.0F,51200,8,1|2,     118,132,245,0,"Birmabright",       "Birmabright",       0,0,1476,   1476,true, false,4,1,1, Dyes.dyeRed,  3, Arrays.asList(new MaterialStack(Materials.Aluminium,5), new MaterialStack(Materials.Magnesium,1), new MaterialStack(Materials.Manganese,1))); //AlMgMn
        BT6 = new Materials                 ( 79, TextureSet.SET_SHINY,128.0F,51200,8,2,     129,57 ,133,0,"BT6",               "BT6",                 0,0,3200,3200,true, false,4,1,1, Dyes.dyeRed,  3, Arrays.asList(new MaterialStack(Materials.Iron,3), new MaterialStack(Materials.Carbon,1), new MaterialStack(Materials.Vanadium,5), new MaterialStack(Materials.Titanium,40), new MaterialStack(Materials.Aluminium,6))).disableAutoGeneratedBlastFurnaceRecipes(); //Fe3C1V5Ti40Al6
