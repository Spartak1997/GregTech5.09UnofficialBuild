...
import static com.impact.item.Core_List_Items.QuantumCrystal;
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        switch (aOreDictName) {
            ...
            case "craftingLensGreen":
                ...
                GT_Values.RA.addLaserEngraverRecipe(ItemList.IC2_LapotronCrystal.getWildcard(1L, new Object[0]), GT_Utility.copyAmount(0L, new Object[]{aStack}), CoreItems.getRecipe(QuantumCrystal.getMetaID(), 1), 256, 480, true);
                break;
